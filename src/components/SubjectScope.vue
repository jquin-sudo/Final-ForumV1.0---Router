  ...
  <div class="topic-view">
    ...
    <div class="topic-footer">
      ...
      <div class="action-buttons">
        <router-link
          v-if="inUse && inuseScope && inuseScope.canEditTopic(topic)"
          :to="{ name: 'modifySubject', params: { topicId: topic._id } }"
        >
          <i class="action-button fas fa-pencil-alt"></i>
        </router-link>
        <i
          v-if="inUse && inuseScope && inuseScope.canDeleteTopic(topic)"
...
import Reply from './RespondScope'
